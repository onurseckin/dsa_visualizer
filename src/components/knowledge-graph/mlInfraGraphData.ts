    ...
    questions: [
      {
        ...
        title: "Causal Lower Triangular Attention Masking",
        algorithmId: "causalLowerTriangularMask",
        difficulty: "Easy",
        type: "ML Systems Implementation",
        description:
          "Applies negative infinity causal mask to upper triangular attention score matrix.",
      },
      {
        id: "flashDecodingSplitKSequenceParallel",
        title: "FlashDecoding Split-K Sequence Parallel Attention",
        algorithmId: "flashDecodingSplitKSequenceParallel",
        difficulty: "Hard",
        type: "ML Systems Implementation",
        description: "Partitions long KV sequence across thread blocks for parallel reduction.",
      },
      {
        id: "groupedQueryAttentionGqaEngine",
        title: "Grouped Query Attention (GQA) Head Projection Engine",
        algorithmId: "groupedQueryAttentionGqaEngine",
        difficulty: "Medium",
        type: "ML Systems Implementation",
        description: "Groups H_q query heads to H_kv key-value heads with memory reduction.",
      },
      {
        id: "kvCacheStepAppend",
        title: "KV Cache Incremental Token Append Engine",
        algorithmId: "kvCacheStepAppend",
        difficulty: "Easy",
        type: "ML Systems Implementation",
        description: "Appends single-step key and value vectors to contiguous KV cache buffer.",
      },
      {
        id: "multiHeadAttentionSplitConcat",
        title: "Multi-Head Attention Head Split and Concat Reshaper",
        algorithmId: "multiHeadAttentionSplitConcat",
        difficulty: "Medium",
        type: "ML Systems Implementation",
        description: "Splits hidden dim D into H heads of dim D_head and concatenates outputs.",
      },
      {
        id: "multiQueryAttentionBroadcast",
        title: "Multi-Query Attention (MQA) Broadcast Engine",
        algorithmId: "multiQueryAttentionBroadcast",
        difficulty: "Medium",
        type: "ML Systems Implementation",
        description: "Broadcasts single key-value head across all query heads during attention.",
      },
      {
        id: "pagedKvCacheBlockMapping",
        title: "Paged KV-Cache Non-Contiguous Block Memory Mapper",
        algorithmId: "pagedKvCacheBlockMapping",
        difficulty: "Hard",
        type: "ML Systems Implementation",
        description:
          "Maps logical sequence token offsets to physical memory blocks via block table.",
      },
      {
        id: "relativePositionInnerProductPreservation",
        title: "RoPE Relative Position Distance Inner Product Preservation",
        algorithmId: "relativePositionInnerProductPreservation",
        difficulty: "Hard",
        type: "ML Systems Implementation",
        description:
          "Validates that inner product depends only on relative token distance (m - n).",
      },
      {
        id: "rope2dComplexPlaneRotation",
        title: "Rotary Position Embeddings 2D Complex Plane Rotation",
        algorithmId: "rope2dComplexPlaneRotation",
        difficulty: "Medium",
        type: "ML Systems Implementation",
        description: "Rotates 2D vector pairs by angle m*theta in complex plane.",
      },
      {
        id: "ropeFrequencyScalingYarn",
        title: "YaRN Frequency Scaling for Long Context RoPE",
        algorithmId: "ropeFrequencyScalingYarn",
        difficulty: "Hard",
        type: "ML Systems Implementation",
        description: "Scales RoPE frequencies for extended context lengths using YaRN method.",
      },
      {
        id: "ropeRotaryPositionEmbeddings",
        title: "Rotary Position Embeddings (RoPE) Multi-Dimensional Matrix",
        algorithmId: "ropeRotaryPositionEmbeddings",
        difficulty: "Medium",
        type: "ML Systems Implementation",
        description:
          "Applies rotary embedding matrix R_m^d to query and key vectors across dimensions.",
      },
      {
        id: "scaledDotProductAttentionMasking",
        title: "Scaled Dot-Product Attention & Softmax Normalization",
        algorithmId: "scaledDotProductAttentionMasking",
        difficulty: "Medium",
        type: "ML Systems Implementation",
        description: "Computes Softmax(Q * K^T / sqrt(d_k)) * V with numerical scaling.",
      },
      {
        id: "singleHeadAttentionMap",
        title: "Single-Head Attention Score & Weight Matrix Calculator",
        algorithmId: "singleHeadAttentionMap",
        difficulty: "Easy",
        type: "ML Systems Implementation",
        description: "Calculates Q*K^T attention scores and Softmax probabilities for single head.",
      },
      {
        id: "slidingWindowPrefixAttentionEngine",
        title: "Sliding Window Prefix Attention Engine",
        algorithmId: "slidingWindowPrefixAttentionEngine",
        difficulty: "Medium",
        type: "ML Systems Implementation",
        description: "Restricts attention mask to sliding window of W previous tokens.",
      },
      {
        id: "softmaxRowNormalize",
        title: "Row-Wise Softmax Normalization Engine",
        algorithmId: "softmaxRowNormalize",
        difficulty: "Easy",
        type: "Foundational Math & DSA",
        description: "Normalizes row vectors of attention logits into probability distributions.",
      },
      {
        id: "vectorInnerProductScaling",
        title: "Vector Inner Product Scaling & Head Dim Normalizer",
        algorithmId: "vectorInnerProductScaling",
        difficulty: "Easy",
        type: "Foundational Math & DSA",
        description: "Scales vector inner products by 1 / sqrt(d_k) to control variance growth.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        algorithmId: "transposedConv2dDeconvIndexMapper",
        difficulty: "Medium",
        type: "ML Systems Implementation",
        description:
      ...
      },
      {
        ...
        algorithmId: "conv1dSlidingWindowDirect",
        difficulty: "Easy",
        type: "Foundational Math & DSA",
      ...
      },
      {
        ...
        algorithmId: "col2imGradAccumulator",
        difficulty: "Medium",
        type: "ML Systems Implementation",
        description:
      ...
      },
      {
        ...
        algorithmId: "multiChannelConv2dAccumulation",
        difficulty: "Easy",
        type: "Foundational Math & DSA",
      ...
      },
      {
        ...
        algorithmId: "winogradF23TransformMatrices",
        difficulty: "Medium",
        type: "ML Systems Implementation",
      ...
      },
      {
        ...
        algorithmId: "winogradMinimalFilteringExecution",
        difficulty: "Medium",
        type: "ML Systems Implementation",
      ...
      },
      {
        ...
        algorithmId: "conv2dSlidingWindowDirect",
        difficulty: "Easy",
        type: "Foundational Math & DSA",
      ...
      },
      {
        ...
        algorithmId: "loweredConv2dGemmExecutionEngine",
        difficulty: "Medium",
        type: "ML Systems Implementation",
      ...
      },
      {
        ...
        algorithmId: "conv2dPaddingStrideOutputShape",
        difficulty: "Easy",
        type: "Foundational Math & DSA",
      ...
      },
      {
        ...
        algorithmId: "fusedDepthwiseSeparableConv2dEngine",
        difficulty: "Hard",
        type: "ML Systems Implementation",
      ...
      },
      {
        ...
        algorithmId: "cudnnImplicitGemmOnTheFlyKernel",
        difficulty: "Hard",
        type: "ML Systems Implementation",
        description:
      ...
      },
      {
        ...
        algorithmId: "receptiveFieldGrowthCalculator",
        difficulty: "Easy",
        type: "Foundational Math & DSA",
        description:
      ...
      },
      {
        ...
        algorithmId: "conv2dToGemmReceptiveFieldUnroll",
        difficulty: "Easy",
        type: "Foundational Math & DSA",
      ...
      },
      {
        ...
        algorithmId: "asStridedZeroCopyIm2colView",
        difficulty: "Medium",
        type: "ML Systems Implementation",
        description:
      ...
      },
      {
        ...
        algorithmId: "fftFrequencyDomainConvolution2d",
        difficulty: "Hard",
        type: "ML Systems Implementation",
        description:
      ...
      },
      {
        ...
        algorithmId: "im2col4dTo2dUnroller",
        difficulty: "Medium",
        type: "ML Systems Implementation",
        description:
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        algorithmId: "xgboostHistogramSplitSearch",
        difficulty: "Medium",
        type: "ML Systems Implementation",
      ...
      },
      {
        ...
        algorithmId: "weightedQuantileSketchHistogram",
        difficulty: "Medium",
        type: "ML Systems Implementation",
        description:
      ...
      },
      {
        ...
        algorithmId: "xgboostSplitGainScoreCalculator",
        difficulty: "Medium",
        type: "ML Systems Implementation",
        description:
