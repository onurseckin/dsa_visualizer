...
export const TriviaSettings: React.FC<TriviaSettingsProps> = ({
  ...
  return (
    <div className="bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-2xl p-8 flex flex-col gap-6 shadow-xl hover:border-[var(--border-accent)] transition-all">
