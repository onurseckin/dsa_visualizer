...
import { sequenceLengthPaddingWasteCalculator, DEFAULT_SEQUENCELENGTHPADDINGWASTECALCULATOR_INPUT, generateSequenceLengthPaddingWasteCalculatorSteps } from "./sequenceLengthPaddingWasteCalculator";

describe("sequence-length-padding-waste-calculator (Static Batching VRAM Padding Waste Calculator)", () => {
  it("should have correct metadata", () => {
    expect(sequenceLengthPaddingWasteCalculator.id).toBe("sequence-length-padding-waste-calculator");
  ...
  it("should generate valid algorithm steps", () => {
    const steps = generateSequenceLengthPaddingWasteCalculatorSteps(DEFAULT_SEQUENCELENGTHPADDINGWASTECALCULATOR_INPUT);
