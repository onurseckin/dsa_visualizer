...
export const sequenceLengthPaddingWasteCalculator: AlgorithmDefinition<sequenceLengthPaddingWasteCalculatorInput> = {
  ...
  topicGuide: {
    ...
    sections: [
      { heading: "Core Concept", body: "Measures wasted VRAM from padding variable-length sequences in static batches." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"Padding Waste","definition":"Wasted VRAM allocated to dummy padding tokens."}],
  },
