...
export const draftModelLookaheadTokenSampler: AlgorithmDefinition<draftModelLookaheadTokenSamplerInput> = {
  ...
  topicGuide: {
    overview: "Draft models quickly propose gamma lookahead tokens for target model verification.",
    sections: [
      { heading: "Core Concept", body: "Generates gamma lookahead candidate tokens using small draft model M_draft." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"Draft Sampler","definition":"Generating lookahead candidate tokens with fast small model."}],
  },
