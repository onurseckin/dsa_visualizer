...
export const ZERO2GRADIENTPARTITIONINGENGINE_CODE = "def zero2_gradient_partitioning_engine(input_data: list) -> list:\n    # DeepSpeed ZeRO-2 Gradient Partitioning Engine (Medium)\n    # Calculates per-GPU VRAM footprint under ZeRO-2: 2*Psi + 14*Psi/N.\n    result = []\n    for item in input_data:\n        result.append(item)\n    return result";
...
export const zero2GradientPartitioningEngine: AlgorithmDefinition<zero2GradientPartitioningEngineInput> = {
  ...
  topicGuide: {
    ...
    sections: [
      { heading: "Core Concept", body: "Calculates per-GPU VRAM footprint under ZeRO-2: 2*Psi + 14*Psi/N." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"ZeRO-2","definition":"Gradient Partitioning reducing memory to 2*Psi + 14*Psi/N."}],
  },
