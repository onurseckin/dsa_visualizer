...
export const ncclTreeVsRingAllreduceSimulator: AlgorithmDefinition<ncclTreeVsRingAllreduceSimulatorInput> = {
  ...
  topicGuide: {
    overview: "Tree All-Reduce reduces latency for small messages; Ring maximizes bandwidth for large tensors.",
    sections: [
      { heading: "Core Concept", body: "Compares latency vs bandwidth bounds for NCCL Double Binary Tree vs Ring topologies." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"NCCL Tree vs Ring","definition":"Topological trade-off between latency and bandwidth utilization."}],
  },
