...
export const nvlinkSymmetricMemoryPeerToPeerEngine: AlgorithmDefinition<nvlinkSymmetricMemoryPeerToPeerEngineInput> = {
  ...
  topicGuide: {
    overview: "NVLink SymmetricMemory provides 900 GB/s peer-to-peer VRAM load/store bandwidth between GPUs.",
    sections: [
      { heading: "Core Concept", body: "Simulates NVLink 900 GB/s direct P2P VRAM reads bypassing host system RAM." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"NVLink P2P","definition":"Peer-to-peer direct GPU VRAM access over NVLink interconnects."}],
  },
