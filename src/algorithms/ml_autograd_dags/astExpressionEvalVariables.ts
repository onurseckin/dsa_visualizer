...
export const astExpressionEvalVariables: AlgorithmDefinition<astExpressionEvalVariablesInput> = {
  ...
  topicGuide: {
    ...
    sections: [
      { heading: "Core Concept", body: "Evaluates AST expression trees with variable substitutions." },
