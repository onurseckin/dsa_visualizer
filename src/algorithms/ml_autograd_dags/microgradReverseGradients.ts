...
export const MICROGRADREVERSEGRADIENTS_CODE = "def micrograd_reverse_gradients(input_data: list) -> list:\n    # Micrograd Reverse-Mode Automatic Differentiation (Medium)\n    # Traverses reversed topological order accumulating gradient fan-outs.\n    result = []\n    for item in input_data:\n        result.append(item)\n    return result";
...
export const microgradReverseGradients: AlgorithmDefinition<microgradReverseGradientsInput> = {
  ...
  topicGuide: {
    ...
    sections: [
      { heading: "Core Concept", body: "Traverses reversed topological order accumulating gradient fan-outs." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"Reverse Autograd","definition":"Computing all parameter gradients in a single backward pass."}],
  },
