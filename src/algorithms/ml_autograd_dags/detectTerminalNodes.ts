...
export const detectTerminalNodes: AlgorithmDefinition<detectTerminalNodesInput> = {
  ...
  topicGuide: {
    ...
    sections: [
      { heading: "Core Concept", body: "Identifies graph sink nodes with out-degree zero." },
