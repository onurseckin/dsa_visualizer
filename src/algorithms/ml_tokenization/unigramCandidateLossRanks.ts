...
`,
  ...
  topicGuide: {
    overview:
      "Comprehensive guide to unigramCandidateLossRanks in machine learning infrastructure.",
    sections: [
      {
        heading: "Core Concept",
        body: "The unigramCandidateLossRanks algorithm is a foundational component.",
      },
      {
