...
`,
  ...
  topicGuide: {
    overview:
      "Comprehensive guide to sentencepieceByteFallbackEncoder in machine learning infrastructure.",
    sections: [
      {
        heading: "Core Concept",
        body: "The sentencepieceByteFallbackEncoder algorithm is a foundational component.",
      },
      {
