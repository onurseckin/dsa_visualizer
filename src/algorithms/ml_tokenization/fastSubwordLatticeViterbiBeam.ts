...
`,
  ...
  topicGuide: {
    overview:
      "Comprehensive guide to fastSubwordLatticeViterbiBeam in machine learning infrastructure.",
    sections: [
      {
        heading: "Core Concept",
        body: "The fastSubwordLatticeViterbiBeam algorithm is a foundational component.",
      },
      {
