...
`,
  ...
  topicGuide: {
    overview:
      "Comprehensive guide to viterbiLatticeSubwordSegmenter in machine learning infrastructure.",
    sections: [
      {
        heading: "Core Concept",
        body: "The viterbiLatticeSubwordSegmenter algorithm is a foundational component.",
      },
      {
