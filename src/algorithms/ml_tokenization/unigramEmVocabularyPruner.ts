...
`,
  ...
  topicGuide: {
    overview:
      "Comprehensive guide to unigramEmVocabularyPruner in machine learning infrastructure.",
    sections: [
      {
        heading: "Core Concept",
        body: "The unigramEmVocabularyPruner algorithm is a foundational component.",
      },
      {
