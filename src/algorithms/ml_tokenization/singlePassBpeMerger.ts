...
export const singlePassBpeMerger: AlgorithmDefinition<string> = {
  ...
  topicGuide: {
    overview: "Comprehensive guide to singlePassBpeMerger in machine learning infrastructure.",
    sections: [
      {
        heading: "Core Concept",
        body: "The singlePassBpeMerger algorithm is a foundational component.",
      },
      {
