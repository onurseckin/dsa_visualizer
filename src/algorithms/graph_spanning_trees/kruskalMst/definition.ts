...
const KRUSKAL_TRIVIA: TriviaMeta = {
  lineExplanations: {
    ...
    11: "union(x, y) merges components containing nodes x and y.",
    12: "Finds representative root leader of node x.",
    13: "Finds representative root leader of node y.",
    14: "Checks if roots are distinct before performing component merge.",
    15: "Checks if rank of rootX is greater than rank of rootY.",
    16: "Attaches lower-rank rootY under higher-rank rootX.",
    17: "Checks if rank of rootX is less than rank of rootY.",
    18: "Attaches lower-rank rootX under higher-rank rootY.",
    19: "Equal rank fallback case.",
    20: "Attaches rootY under rootX when ranks are equal.",
    21: "Increments rank of rootX because equal-rank merge increases tree depth.",
    22: "Blank line separating union method from connected method.",
    23: "connected(x, y) checks if nodes x and y belong to the same component.",
    24: "Returns True if nodes x and y share the exact same root leader.",
    25: "Blank line separating UnionFind class from kruskal_mst function.",
    26: "Entry point: kruskal_mst(nodes, edges) computes the Minimum Spanning Tree.",
    27: "Maps string node IDs to 0-based integer indices for UnionFind.",
    28: "Instantiates UnionFind sized to total number of graph vertices.",
    29: "Sorts edges in ascending order by weight so lightest edges are examined first.",
    30: "Initializes empty list to collect accepted MST edges.",
    31: "Iterates over sorted edges from lightest to heaviest.",
    32: "Translates edge endpoint node IDs to integer indices.",
    33: "Checks if endpoints u and v are already connected in the MST.",
    34: "Merges the components of u and v to accept the edge.",
    35: "Appends accepted edge to the MST edge list.",
    36: "Blank line separating loop from return statement.",
    37: "Returns completed list of Minimum Spanning Tree edges.",
    38: "End of kruskal_mst function.",
    39: "Returns final MST edge collection.",
  },
};
