...
export const antiDiagonalExtraction: AlgorithmDefinition<antiDiagonalExtractionInput> = {
  ...
  topicGuide: {
    ...
    sections: [
      { heading: "Core Concept", body: "Extracts anti-diagonal stripes from a 2D tensor to inspect strided memory access patterns." },
