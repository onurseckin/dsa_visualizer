    ...
    sections: [
      {
        ...
        body: "Constructs custom virtual multi-dimensional views without reallocating underlying VRAM buffers.",
      },
      {
