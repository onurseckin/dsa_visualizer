...
export const transposeSquareMatrix: AlgorithmDefinition<transposeSquareMatrixInput> = {
  ...
  topicGuide: {
    ...
    sections: [
      { heading: "Core Concept", body: "Swaps off-diagonal matrix elements (A[i][j] <-> A[j][i]) to transpose a square tensor." },
