...
export const TWOELEMENTMAXSUBTRACTIONSHIFT_CODE = "def two_element_max_subtraction_shift(input_data: list) -> list:\n    # Shift-Invariant Log-Sum-Exp Normalization (Easy)\n    # Subtracts vector max to prevent floating point overflow in exponential calculations.\n    result = []\n    for item in input_data:\n        result.append(item)\n    return result";
...
export const generateTwoElementMaxSubtractionShiftSteps = (
  ...
  addStep(
    1,
    "Initialize Shift-Invariant Log-Sum-Exp Normalization",
...
const TWOELEMENTMAXSUBTRACTIONSHIFT_TRIVIA: TriviaMeta = {
  ...
  lineExplanations: {
    1: "Defines entry point for Shift-Invariant Log-Sum-Exp Normalization.",
...
export const twoElementMaxSubtractionShift: AlgorithmDefinition<twoElementMaxSubtractionShiftInput> = {
  ...
  topicGuide: {
    overview: "Softmax max-subtraction prevents FP16 infinity overflow.",
    sections: [
      { heading: "Core Concept", body: "Subtracts vector max to prevent floating point overflow in exponential calculations." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"Shift Invariance","definition":"Softmax(x) == Softmax(x - c)."}],
  },
