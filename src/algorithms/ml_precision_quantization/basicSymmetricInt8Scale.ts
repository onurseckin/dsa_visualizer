...
export const BASICSYMMETRICINT8SCALE_CODE = "def basic_symmetric_int8_scale(input_data: list) -> list:\n    # Symmetric INT8 Scale Factor Calculator (Easy)\n    # Calculates symmetric scale factor S = max(|X|) / 127.0.\n    result = []\n    for item in input_data:\n        result.append(item)\n    return result";
...
export const generateBasicSymmetricInt8ScaleSteps = (
  ...
  addStep(
    1,
    "Initialize Symmetric INT8 Scale Factor Calculator",
...
const BASICSYMMETRICINT8SCALE_TRIVIA: TriviaMeta = {
  ...
  lineExplanations: {
    1: "Defines entry point for Symmetric INT8 Scale Factor Calculator.",
...
export const basicSymmetricInt8Scale: AlgorithmDefinition<basicSymmetricInt8ScaleInput> = {
  ...
  topicGuide: {
    overview: "Symmetric quantization maps zero to integer zero with scale factor S.",
    sections: [
      { heading: "Core Concept", body: "Calculates symmetric scale factor S = max(|X|) / 127.0." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"Symmetric Scale","definition":"Quantization scale centered around zero."}],
  },
