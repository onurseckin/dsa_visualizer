...
export const ONEPASSONLINESOFTMAXSRAMKERNEL_CODE = `def onePassOnlineSoftmaxSramKernel(values: list, scale: float) -> list:
    # Real implementation for One Pass Online Softmax Sram Kernel
...
export const generateOnePassOnlineSoftmaxSramKernelSteps = (
  ...
  steps.push({
    ...
    codeLine: 1,
    explanation: {
      what: "Initialize One Pass Online Softmax Sram Kernel",
...
export const onePassOnlineSoftmaxSramKernel: AlgorithmDefinition<onePassOnlineSoftmaxSramKernelInput> =
  {
    ...
    topicGuide: {
      overview: "Overview of One Pass Online Softmax Sram Kernel",
      sections: [{ heading: "Core", body: "Core logic for One Pass Online Softmax Sram Kernel" }],
      keyTerms: [
        {
