...
export const IEEE754BITWISEDISSECTOR_CODE = "def ieee754_bitwise_dissector(input_data: list) -> list:\n    # IEEE-754 Floating Point Bit Dissector (Medium)\n    # Parses FP32 / FP16 bits into Sign, Exponent, and Mantissa fields.\n    result = []\n    for item in input_data:\n        result.append(item)\n    return result";
...
export const generateIeee754BitwiseDissectorSteps = (
  ...
  addStep(
    1,
    "Initialize IEEE-754 Floating Point Bit Dissector",
...
const IEEE754BITWISEDISSECTOR_TRIVIA: TriviaMeta = {
  ...
  lineExplanations: {
    1: "Defines entry point for IEEE-754 Floating Point Bit Dissector.",
...
export const ieee754BitwiseDissector: AlgorithmDefinition<ieee754BitwiseDissectorInput> = {
  ...
  topicGuide: {
    overview: "Dissecting float bits illustrates dynamic range vs precision tradeoffs.",
    sections: [
      { heading: "Core Concept", body: "Parses FP32 / FP16 bits into Sign, Exponent, and Mantissa fields." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"IEEE-754","definition":"Standard representation for binary floating-point numbers."}],
  },
