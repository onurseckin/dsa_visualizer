...
export const fp16OverflowRescalingEngine: AlgorithmDefinition<fp16OverflowRescalingEngineInput> = {
  ...
  description: "Implementation of Fp16 Overflow Rescaling Engine.",
  ...
  topicGuide: {
    overview: "Overview of Fp16 Overflow Rescaling Engine",
    sections: [{ heading: "Core", body: "Core logic for Fp16 Overflow Rescaling Engine" }],
    keyTerms: [
      {
