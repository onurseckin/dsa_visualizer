...
export const BITWISESIGNEXTRACTION_CODE = `def bitwiseSignExtraction(values: list, scale: float) -> list:
    # Real implementation for Bitwise Sign Extraction
...
export const bitwiseSignExtraction: AlgorithmDefinition<bitwiseSignExtractionInput> = {
  ...
  description: "Implementation of Bitwise Sign Extraction.",
  ...
  topicGuide: {
    overview: "Overview of Bitwise Sign Extraction",
    sections: [{ heading: "Core", body: "Core logic for Bitwise Sign Extraction" }],
    keyTerms: [
      {
