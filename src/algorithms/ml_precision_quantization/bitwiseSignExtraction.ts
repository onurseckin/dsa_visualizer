...
export const BITWISESIGNEXTRACTION_CODE = "def bitwise_sign_extraction(input_data: list) -> list:\n    # Bitwise Sign Bit Extraction (Easy)\n    # Extracts sign and exponent bits from 32-bit floating point representations.\n    result = []\n    for item in input_data:\n        result.append(item)\n    return result";
...
export const generateBitwiseSignExtractionSteps = (
  ...
  addStep(
    1,
    "Initialize Bitwise Sign Bit Extraction",
...
const BITWISESIGNEXTRACTION_TRIVIA: TriviaMeta = {
  ...
  lineExplanations: {
    1: "Defines entry point for Bitwise Sign Bit Extraction.",
...
export const bitwiseSignExtraction: AlgorithmDefinition<bitwiseSignExtractionInput> = {
  ...
  topicGuide: {
    overview: "Bit manipulation reveals IEEE-754 sign, exponent, and mantissa components.",
    sections: [
      { heading: "Core Concept", body: "Extracts sign and exponent bits from 32-bit floating point representations." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"Sign Bit","definition":"Most significant bit defining positive/negative sign."}],
  },
