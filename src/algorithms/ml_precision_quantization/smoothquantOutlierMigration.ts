...
def smoothquantoutliermigration(fp32_weights, scale, zero_point):
    """
...
export const generateSmoothquantOutlierMigrationSteps = (
  ...
  steps.push({
    ...
    codeLine: 1,
    explanation: {
      what: "Initialize Smoothquant Outlier Migration",
...
export const smoothquantOutlierMigration: AlgorithmDefinition<smoothquantOutlierMigrationInput> = {
  ...
  topicGuide: {
    ...
    keyTerms: [
      {
        term: "Smoothquant Engine",
        definition:
          "The underlying algorithmic system implementing smoothquant outlier migration operations for deep learning workloads.",
      },
      {
