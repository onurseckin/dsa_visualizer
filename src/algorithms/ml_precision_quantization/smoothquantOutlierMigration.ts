...
export const SMOOTHQUANTOUTLIERMIGRATION_CODE = `def smoothquantOutlierMigration(values: list, scale: float) -> list:
    # Real implementation for Smoothquant Outlier Migration
...
export const smoothquantOutlierMigration: AlgorithmDefinition<smoothquantOutlierMigrationInput> = {
  ...
  description: "Implementation of Smoothquant Outlier Migration.",
  ...
  topicGuide: {
    overview: "Overview of Smoothquant Outlier Migration",
    sections: [{ heading: "Core", body: "Core logic for Smoothquant Outlier Migration" }],
    keyTerms: [
      {
