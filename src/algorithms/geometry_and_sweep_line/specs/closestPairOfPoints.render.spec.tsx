...
import { generateClosestPairOfPointsSteps, DEFAULT_CLOSEST_PAIR_OF_POINTS_INPUT } from "../closestPairOfPoints";
...
describe("closestPairOfPoints React component spec", () => {
  it("renders GraphVisualizer with closest pair snapshot", () => {
    ...
    render(<GraphVisualizer nodes={snapshot.nodes} edges={snapshot.edges} title="Closest Pair of Points via Sweep Line" />);
