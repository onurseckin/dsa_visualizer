...
`,
  ...
  topicGuide: {
    overview:
      "Comprehensive guide to hnswHeuristicSpatialPruning in machine learning infrastructure.",
    sections: [
      {
        heading: "Core Concept",
        body: "The hnswHeuristicSpatialPruning algorithm is a foundational component.",
      },
      {
