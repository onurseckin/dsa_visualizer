...
`,
  ...
  topicGuide: {
    overview:
      "Comprehensive guide to cosineSimilarityNormalized in machine learning infrastructure.",
    sections: [
      {
        heading: "Core Concept",
        body: "The cosineSimilarityNormalized algorithm is a foundational component.",
      },
      {
