...
export const cosineSimilarityNormalized: AlgorithmDefinition<CosineSimilarityNormalizedInput> = {
  ...
  examples: [
    {
      ...
      input: {} as unknown as CosineSimilarityNormalizedInput, // Will need actual data but cast to any
      output: "Basic Success",
      explanation: "A simple clear basic example for cosineSimilarityNormalized.",
    },
    {
      kind: "complex",
      inputDisplay: "Complex Input",
      outputDisplay: "Complex Output",
      input: {} as unknown as CosineSimilarityNormalizedInput,
  ...
  defaultInput: {} as unknown as CosineSimilarityNormalizedInput,
  code: `
def cosineSimilarityNormalized(query_vector, database_embeddings, top_k=3):
    """
...
`,
    ...
    keyTerms: [
      {
        term: "Q2: Engine",
        definition:
          "The underlying algorithmic system implementing q2: cosine similarity operations for deep learning workloads.",
      },
      {
  ...
  generateSteps: (_input: CosineSimilarityNormalizedInput) => {
