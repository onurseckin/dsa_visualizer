...
export const VARIANCEREDUCTIONSPLIT_CODE = "def variance_reduction_split(input_data: list) -> list:\n    # Regression Variance Reduction Splitter (Easy)\n    # Computes target variance reduction VR(S, A) for regression splits.\n    result = []\n    for item in input_data:\n        result.append(item)\n    return result";
...
export const generateVarianceReductionSplitSteps = (
  ...
  addStep(
    1,
    "Initialize Regression Variance Reduction Splitter",
...
const VARIANCEREDUCTIONSPLIT_TRIVIA: TriviaMeta = {
  ...
  lineExplanations: {
    1: "Defines entry point for Regression Variance Reduction Splitter.",
...
export const varianceReductionSplit: AlgorithmDefinition<varianceReductionSplitInput> = {
  ...
  topicGuide: {
    ...
    sections: [
      { heading: "Core Concept", body: "Computes target variance reduction VR(S, A) for regression splits." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"Variance Reduction","definition":"Reduction in target variance after split."}],
  },
