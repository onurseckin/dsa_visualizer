...
export const GPUHISTQUANTIZEDHISTOGRAMKERNEL_CODE = `
def gpuhistquantizedhistogramkernel(feature_values, targets, split_threshold):
    """
...
export const gpuHistQuantizedHistogramKernel: AlgorithmDefinition<gpuHistQuantizedHistogramKernelInput> =
  {
    ...
    topicGuide: {
      overview: "Overview of GPU `gpu_hist` Shared Memory Quantized Histogram Builder",
