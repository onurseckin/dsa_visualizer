...
export const MISSINGVALUEDEFAULTDIRECTIONSPLITTER_CODE = "def missing_value_default_direction_splitter(input_data: list) -> list:\n    # XGBoost Missing Value Default Direction Allocator (Hard)\n    # Learns optimal default split direction (left vs right) for missing feature values.\n    result = []\n    for item in input_data:\n        result.append(item)\n    return result";
...
export const generateMissingValueDefaultDirectionSplitterSteps = (
  ...
  addStep(
    1,
    "Initialize XGBoost Missing Value Default Direction Allocator",
...
const MISSINGVALUEDEFAULTDIRECTIONSPLITTER_TRIVIA: TriviaMeta = {
  ...
  lineExplanations: {
    1: "Defines entry point for XGBoost Missing Value Default Direction Allocator.",
...
export const missingValueDefaultDirectionSplitter: AlgorithmDefinition<missingValueDefaultDirectionSplitterInput> = {
  ...
  topicGuide: {
    overview: "XGBoost tests assigning missing values to left vs right child to maximize gain score.",
    sections: [
      { heading: "Core Concept", body: "Learns optimal default split direction (left vs right) for missing feature values." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"Default Direction","definition":"Optimal branch assignment for missing feature values."}],
  },
