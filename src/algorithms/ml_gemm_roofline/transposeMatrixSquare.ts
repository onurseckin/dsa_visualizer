...
export const transposeMatrixSquare: AlgorithmDefinition<transposeMatrixSquareInput> = {
  ...
  topicGuide: {
    ...
    sections: [
      { heading: "Core Concept", body: "Swaps rows and columns of a square matrix in-place." },
