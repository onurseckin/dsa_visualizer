...
export const CONV1DSHAREDMEMORYSCRATCHPAD_CODE = "def conv1d_shared_memory_scratchpad(input_data: list) -> list:\n    # 1D Conv GPU SRAM Scratchpad Simulator (Medium)\n    # Loads input tiles and halo regions into fast shared memory scratchpad.\n    result = []\n    for item in input_data:\n        result.append(item)\n    return result";
...
const CONV1DSHAREDMEMORYSCRATCHPAD_TRIVIA: TriviaMeta = {
  ...
  lineExplanations: {
    1: "Defines entry point for 1D Conv GPU SRAM Scratchpad Simulator.",
...
export const conv1dSharedMemoryScratchpad: AlgorithmDefinition<conv1dSharedMemoryScratchpadInput> = {
  ...
  categories: ["ml_gemm_roofline","sliding_window"] as any,
  difficulty: "Medium",
  isMlInfra: true,
  mlInfraLevel: 2,
  ...
  topicGuide: {
    overview: "Shared memory scratchpads eliminate redundant HBM reads for overlapping stencils.",
    sections: [
      { heading: "Core Concept", body: "Loads input tiles and halo regions into fast shared memory scratchpad." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"SRAM Scratchpad","definition":"Fast on-chip GPU shared memory buffer."}],
  },
