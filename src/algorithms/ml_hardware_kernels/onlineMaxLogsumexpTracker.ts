...
export const ONLINEMAXLOGSUMEXPTRACKER_CODE = "def online_max_logsumexp_tracker(input_data: list) -> list:\n    # Online Softmax Running Max & LSE Tracker (Easy)\n    # Tracks running max m_new and log-sum-exp normalization across tiles.\n    result = []\n    for item in input_data:\n        result.append(item)\n    return result";
...
export const generateOnlineMaxLogsumexpTrackerSteps = (
  ...
  addStep(
    1,
    "Initialize Online Softmax Running Max & LSE Tracker",
...
const ONLINEMAXLOGSUMEXPTRACKER_TRIVIA: TriviaMeta = {
  ...
  lineExplanations: {
    1: "Defines entry point for Online Softmax Running Max & LSE Tracker.",
...
export const onlineMaxLogsumexpTracker: AlgorithmDefinition<onlineMaxLogsumexpTrackerInput> = {
  ...
  topicGuide: {
    overview: "Online max tracking enables 1-pass Softmax without storing intermediate matrices.",
    sections: [
      { heading: "Core Concept", body: "Tracks running max m_new and log-sum-exp normalization across tiles." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"Online Softmax Max","definition":"Tracking running max m_new = max(m_old, m_tile)."}],
  },
