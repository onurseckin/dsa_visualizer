...
export const HBMVSSRAMBANDWIDTHCALCULATOR_CODE = "def hbm_vs_sram_bandwidth_calculator(input_data: list) -> list:\n    # HBM vs SRAM Bandwidth & Latency Calculator (Easy)\n    # Calculates access latency and bandwidth speedups comparing SRAM vs HBM.\n    result = []\n    for item in input_data:\n        result.append(item)\n    return result";
...
export const generateHbmVsSramBandwidthCalculatorSteps = (
  ...
  addStep(
    1,
    "Initialize HBM vs SRAM Bandwidth & Latency Calculator",
...
const HBMVSSRAMBANDWIDTHCALCULATOR_TRIVIA: TriviaMeta = {
  ...
  lineExplanations: {
    1: "Defines entry point for HBM vs SRAM Bandwidth & Latency Calculator.",
...
export const hbmVsSramBandwidthCalculator: AlgorithmDefinition<hbmVsSramBandwidthCalculatorInput> = {
  ...
  topicGuide: {
    ...
    sections: [
      { heading: "Core Concept", body: "Calculates access latency and bandwidth speedups comparing SRAM vs HBM." },
