...
export const TRITONFUSEDADDSOFTMAXDROPOUTKERNEL_CODE = "def triton_fused_add_softmax_dropout_kernel(input_data: list) -> list:\n    # Triton Fused Add + Softmax + Dropout Kernel (Medium)\n    # Fuses residual add, softmax, and dropout into single pass SRAM kernel.\n    result = []\n    for item in input_data:\n        result.append(item)\n    return result";
...
const TRITONFUSEDADDSOFTMAXDROPOUTKERNEL_TRIVIA: TriviaMeta = {
  ...
  lineExplanations: {
    1: "Defines entry point for Triton Fused Add + Softmax + Dropout Kernel.",
...
export const tritonFusedAddSoftmaxDropoutKernel: AlgorithmDefinition<tritonFusedAddSoftmaxDropoutKernelInput> = {
  ...
  topicGuide: {
    ...
    sections: [
      { heading: "Core Concept", body: "Fuses residual add, softmax, and dropout into single pass SRAM kernel." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"Elementwise Fusion","definition":"Combining multiple activation ops into single SRAM kernel."}],
  },
