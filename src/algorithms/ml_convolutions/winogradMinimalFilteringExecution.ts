...
export const WINOGRADMINIMALFILTERINGEXECUTION_CODE = "def winograd_minimal_filtering_execution(input_data: list) -> list:\n    # Winograd F(2x2, 3x3) Execution Engine (Medium)\n    # Executes Y = A^T [(G g G^T) (B^T d B)] A fast Winograd convolution.\n    result = []\n    for item in input_data:\n        result.append(item)\n    return result";
...
export const winogradMinimalFilteringExecution: AlgorithmDefinition<winogradMinimalFilteringExecutionInput> = {
  ...
  topicGuide: {
    overview: "Winograd convolution multiplies transformed tile matrices to achieve 2.25x speedup.",
    sections: [
      { heading: "Core Concept", body: "Executes Y = A^T [(G g G^T) (B^T d B)] A fast Winograd convolution." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"Winograd GEMM","definition":"Transform-domain fast convolution algorithm."}],
  },
