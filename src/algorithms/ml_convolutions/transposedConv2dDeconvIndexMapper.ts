...
export const TRANSPOSEDCONV2DDECONVINDEXMAPPER_CODE = "def transposed_conv2d_deconv_index_mapper(input_data: list) -> list:\n    # Transposed 2D Convolution (Deconvolution) Engine (Medium)\n    # Maps deconvolution upsampling indices without allocating sparse zero-filled tensors.\n    result = []\n    for item in input_data:\n        result.append(item)\n    return result";
...
export const transposedConv2dDeconvIndexMapper: AlgorithmDefinition<transposedConv2dDeconvIndexMapperInput> = {
  ...
  topicGuide: {
    overview: "Transposed convolution upsamples spatial feature maps using transposed index mapping.",
    sections: [
      { heading: "Core Concept", body: "Maps deconvolution upsampling indices without allocating sparse zero-filled tensors." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"Transposed Conv","definition":"Upsampling spatial feature maps via transposed convolution."}],
  },
