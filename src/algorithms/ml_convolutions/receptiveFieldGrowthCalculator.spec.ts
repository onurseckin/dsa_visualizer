...
import { receptiveFieldGrowthCalculator, DEFAULT_RECEPTIVEFIELDGROWTHCALCULATOR_INPUT, generateReceptiveFieldGrowthCalculatorSteps } from "./receptiveFieldGrowthCalculator";
...
describe("receptive-field-growth-calculator (2D Receptive Field Growth Calculator)", () => {
  ...
  it("should generate valid algorithm steps", () => {
    const steps = generateReceptiveFieldGrowthCalculatorSteps(DEFAULT_RECEPTIVEFIELDGROWTHCALCULATOR_INPUT);
