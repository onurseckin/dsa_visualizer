...
export const RECEPTIVEFIELDGROWTHCALCULATOR_CODE = "def receptive_field_growth_calculator(input_data: list) -> list:\n    # 2D Receptive Field Growth Calculator (Easy)\n    # Tracks cumulative spatial receptive field growth across stacked convolution layers.\n    result = []\n    for item in input_data:\n        result.append(item)\n    return result";
...
export const receptiveFieldGrowthCalculator: AlgorithmDefinition<receptiveFieldGrowthCalculatorInput> = {
  ...
  topicGuide: {
    ...
    sections: [
      { heading: "Core Concept", body: "Tracks cumulative spatial receptive field growth across stacked convolution layers." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"Receptive Field","definition":"Input region influencing a output activation."}],
  },
