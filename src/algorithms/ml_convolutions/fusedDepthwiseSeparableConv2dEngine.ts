...
export const fusedDepthwiseSeparableConv2dEngine: AlgorithmDefinition<fusedDepthwiseSeparableConv2dEngineInput> = {
  ...
  topicGuide: {
    ...
    sections: [
      { heading: "Core Concept", body: "Fuses 3x3 depthwise spatial conv with 1x1 pointwise channel conv in SRAM." },
      { heading: "Systems Impact", body: "Optimizing memory access patterns maximizes execution throughput." },
    ],
    keyTerms: [{"term":"Depthwise Separable Conv","definition":"Decoupling spatial filtering from cross-channel mixing."}],
  },
