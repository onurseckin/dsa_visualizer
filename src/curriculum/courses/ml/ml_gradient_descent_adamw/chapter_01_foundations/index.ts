...
import { page_01_core_concepts } from "./page_01_core_concepts";
import { page_02_systems } from "./page_02_systems";

export const chapter_1: CourseChapter = {
  id: "ml_gradient_descent_adamw_chapter_01_foundations",
  chapterNumber: 1,
  title: "Gradient Descent & AdamW Optimization",
  subtitle: "First-Order Dynamics, Convergence Bounds, and Decoupled Weight Decay",
  estimatedMinutes: 60,
  sections: [],
  pages: [page_01_core_concepts, page_02_systems],
};
