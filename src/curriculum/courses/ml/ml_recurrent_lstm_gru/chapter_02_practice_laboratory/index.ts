...
export const chapter_2: CourseChapter = {
  id: "ml_recurrent_lstm_gru_chapter_02_practice_laboratory",
  chapterNumber: 2,
  title: "Practice Laboratory: Recurrent Architectures (LSTM & GRU)",
  subtitle: "Interactive Problems, Mathematical Derivations, and Systems Scenarios",
  estimatedMinutes: 45,
  sections: [],
