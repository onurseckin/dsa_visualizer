...
import { page as page_1 } from "./page_01_dsa_foundations";
import { page as page_2 } from "./page_02_math_proofs";
import { page as page_3 } from "./page_03_systems_scenarios";

export const chapter_2: CourseChapter = {
  id: "ml_ring_allreduce_collective_chapter_02_practice_laboratory",
  chapterNumber: 2,
