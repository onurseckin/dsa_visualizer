...
import { page1 as page_01_dsa_foundations } from "./page_01_dsa_foundations";
import { page2 as page_02_math_proofs } from "./page_02_math_proofs";
import { page3 as page_03_systems_scenarios } from "./page_03_systems_scenarios";

export const chapter_2: CourseChapter = {
  id: "ml_rope_gqa_attention_chapter_02_practice_laboratory",
  chapterNumber: 2,
