...
import { page_01_systems_scenarios as page_2 } from "./page_01_systems_scenarios";
import { page2 as page_3 } from "./page_02_math_proofs";
import { page3 as page_4 } from "./page_03_systems_scenarios";

export const chapter_2: CourseChapter = {
  id: "ml_activations_online_softmax_chapter_02_practice_laboratory",
  chapterNumber: 2,
