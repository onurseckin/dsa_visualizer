...
import { page_01_mental_model as page_1 } from "./page_01_mental_model";
import { page_02_math_and_code as page_2 } from "./page_02_math_and_code";
import { page_03_systems_and_bugs as page_3 } from "./page_03_systems_and_bugs";

export const chapter_1: CourseChapter = {
  id: "dsa_stack_and_queue_chapter_01_core",
  chapterNumber: 1,
