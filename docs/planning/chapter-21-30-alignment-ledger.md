...
| 25 | stone-game-dp | repair runner and educational contract | The source binding is Ch25 §25.1, but prose/default visualization still describe endpoint-picking Stone Game while the runner/reference use Stone Game III's take-one-to-three rule. Reconcile one contract and add focused fixtures. |
