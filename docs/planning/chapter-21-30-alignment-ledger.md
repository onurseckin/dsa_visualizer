...
| 25 | game-state-minimax, mex-subtraction-game, stone-game-dp | repair metadata and code | Source labels incorrectly say Ch23; the subtraction-game implementation currently returns `True` for every case. |
